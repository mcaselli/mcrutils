...
#'
#' This function checks if the provided date(s) are business days according to
#' the specified QuantLib calendar.
#'
...
#' @return A logical vector indicating whether each date is a business day in
