...
- **Michael Caselli**. Author, maintainer.

## Citation

Source:
[`DESCRIPTION`](https://github.com/mcaselli/mcrutils/blob/0.0.0.9012/DESCRIPTION)

Caselli M (2026). *mcrutils: Miscellaneous Utilities for Data Cleaning,
Analysis, and Reporting*. R package version 0.0.0.9012,
